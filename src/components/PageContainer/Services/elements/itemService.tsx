  ...
  return (
    <div className="grid grid-cols-12 lg:gap-10">
      ...
      <div className="grid grid-cols-12 col-span-12 custom-bg text-white md:gap-8 md:pl-2 md:pt-10 lg:col-span-6 lg:gap-14 lg:pl-8 xl:col-span-4 xl:pl-2">
        ...
        <div className="text-white col-span-12 md:col-span-11 lg:col-span-7">
      ...
      {/* second-item */}
      <div className="grid grid-cols-12 col-span-12 custom-bg text-white md:gap-8 md:pl-2 md:pt-14 lg:col-span-6 lg:pt-10 lg:gap-14 lg:pl-8 xl:col-span-4 xl:pl-2">
        <div className="grid col-span-12 py-4 md:col-span-1 md:items-center md:justify-center">
          <svg
            width="50"
            height="50"
      ...
      <div className="grid grid-cols-12 col-span-12 custom-bg text-white md:gap-8 md:pl-2 md:py-14 lg:col-span-6 lg:gap-14 lg:pt-10 lg:pl-8 xl:col-span-4 xl:pl-2">
        ...
        <div className="text-white col-span-12 pb-10 md:col-span-11 lg:col-span-7 ">
          <h1 className="text-white font-bold text-xl">Digital Marketing</h1>
          <p className="text-white text-lg py-4">
            We help you at every step of your learning and career journey. From
            beginner to getting hired to advancing your skills and having a
